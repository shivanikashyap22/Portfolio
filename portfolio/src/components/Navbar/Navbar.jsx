            ...
            <nav className="bg-inherit  py-5">
                <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 flex justify-between items-center ">
                        ...
                        <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div className="hidden sm:ml-6 sm:block">
                                <div className="flex space-x-4">
                                    ...
                                    <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-black-300 hover:bg-gray-700 hover:text-white">About</a>
                                    <a href="#" className="rounded-md    px-3 py-2 text-sm font-medium text-black-300 hover:bg-gray-700 hover:text-white">Portfolio</a>
                                    <a href="/contact" className="rounded-md px-3 py-2 text-sm font-medium text-black-300 hover:bg-gray-700 hover:text-white">Contact</a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" onClick={handleToggle} value={toggler} role="switch" id="flexSwitchCheckDefault" />
